...
<?php
    ...
    $zalo_id = file_get_contents("https://api.speed4g.me/qrzalopay/" . CONFIG['GATE']['ZALOPAY']['PHONE'] . "");
$linkQR = "https://chart.googleapis.com/chart?cht=qr&chs=300x300&chl=" . urlencode("https://social.zalopay.vn/mt-gateway/v1/private-qr?amount=" . $amount . "&note=". strtoupper(CONFIG['KEYWORD']) ."". $order_id."&receiver_id=" . $zalo_id . "");
?>
<html lang="vi">
    ...
    <body>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="message" id="loginForm">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="info-qr-code">
                                                    <p>
                                                        ...
                                                        alt="" />
                                                        Sử Dụng <strong> App ZaloPay</strong>  Để Quét Mã Phía Trên.
                                                    </p>
													...
													<div>Số Tiền: <span style="font-weight:bold"><?php echo number_format($amount);?> VNĐ</span></div><br>
														<div>Ví Điện Tử: <span style="font-weight:bold">ZaloPay</span></div><br>
														<div class="stkmomo">Số Tài Khoản: <span style="font-weight:bold" class="copyclipboard" data-content="<?php echo CONFIG['GATE']['ZALOPAY']['PHONE'];?>"><?php echo CONFIG['GATE']['ZALOPAY']['PHONE'];?></span> <i class="fa fa-clipboard" aria-hidden="true"></i></div><br>
														<div>Chủ Tài Khoản: </span> <span style="font-weight:bold"><?php echo CONFIG['GATE']['ZALOPAY']['ACCOUNT_NAME'];?></span></div><br>
													<div class="note-box">
										...
										<div class="row">
											<div class="col-xs-12 col-sm-12 col-md-12">
												<div class="provider">Cung Cấp Bởi <a href="https://zalo.me/0333725953">ADMIN SPEED4G.ME</a></div>
											</div>
										</div>
                                    </div>
                                </div>
		...
		<script>
			...
			var stk_atm = "<?php echo CONFIG['GATE']['ZALOPAY']['PHONE'];?>";
