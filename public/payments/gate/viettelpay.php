...
<?php
    $linkQR = "https://img.vietqr.io/image/" . CONFIG['GATE']['VIETTELPAY']['BANKID'] . "-" . CONFIG['GATE']['VIETTELPAY']['ACCOUNT_NUMBER'] . "-5NejMB9.jpg?amount=" . $amount . "&addInfo=" . strtoupper(CONFIG['KEYWORD']) . "" . $order_id . "&accountName=" . CONFIG['GATE']['VIETTELPAY']['ACCOUNT_NAME'] . "";
?>
<html lang="vi">
    ...
    <body>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="info-qr-code">
													...
													<div>Số Tiền: <span style="font-weight:bold"><?php echo number_format($amount);?> VNĐ</span></div><br>
														<div>Ngân Hàng: <span style="font-weight:bold">MBBank</span></div><br>
														<div class="stkmomo">Số Tài Khoản: <span style="font-weight:bold" class="copyclipboard" data-content="<?php echo CONFIG['GATE']['VIETTELPAY']['ACCOUNT_NUMBER'];?>"><?php echo CONFIG['GATE']['VIETTELPAY']['ACCOUNT_NUMBER'];?></span> <i class="fa fa-clipboard" aria-hidden="true"></i></div><br>
														<div>Chủ Tài Khoản: </span> <span style="font-weight:bold"><?php echo CONFIG['GATE']['VIETTELPAY']['ACCOUNT_NAME'];?></span></div><br>
													<div class="note-box">
		...
		<script>
			...
			var stk_atm = "<?php echo CONFIG['GATE']['VIETTELPAY']['ACCOUNT_NUMBER'];?>";
