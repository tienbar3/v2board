...
<?php
    $linkQR = "https://img.vietqr.io/image/" . CONFIG['GATE']['VIETINBANK']['BANKID'] . "-" . CONFIG['GATE']['VIETINBANK']['ACCOUNT_NUMBER'] . "-oHnyCn7.jpg?amount=" . $amount . "&addInfo=" . strtoupper(CONFIG['KEYWORD']) . "" . $order_id . "&accountName=" . CONFIG['GATE']['VIETINBANK']['ACCOUNT_NAME'] . "";
?>
<html lang="vi">
    ...
    <head id="j_idt6">
        ...
        <link rel="shortcut icon" href="https://vpn.xn--ss-8ja.vn/theme/GIF/icosos.png"/>
    <link
        rel="icon"
        type="image/png"
        sizes="192x192"
        href="https://vpn.xn--ss-8ja.vn/theme/GIF/icosos.png"
    />
    <link
    ...
    <body>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="info-qr-code">
                                                    <p>
                                                        ...
                                                        alt="" />
                                                        Sử Dụng <strong> App Banking</strong>  Để Quét Mã Phía Trên.
                                                    </p>
													...
													<div>Số Tiền: <span style="font-weight:bold"><?php echo number_format($amount);?> VNĐ</span></div><br>
														<div>Ngân Hàng: <span style="font-weight:bold">VietinBank</span></div><br>
														<div class="stkmomo">Số Tài Khoản: <span style="font-weight:bold" class="copyclipboard" data-content="<?php echo CONFIG['GATE']['VIETINBANK']['ACCOUNT_NUMBER'];?>"><?php echo CONFIG['GATE']['VIETINBANK']['ACCOUNT_NUMBER'];?></span> <i class="fa fa-clipboard" aria-hidden="true"></i></div><br>
														<div>Chủ Tài Khoản: </span> <span style="font-weight:bold"><?php echo CONFIG['GATE']['VIETINBANK']['ACCOUNT_NAME'];?></span></div><br>
													<div class="note-box">
                                                    ...
                                                    <p id="status">
                                                        ...
                                                        Đang Chờ Thanh Toán ... <br><br>
                                                    
                                                    </p>
                                                    <h4><font color="red"><b>Chú ý:</b></font> Đơn chuyển khoản từ 23h -> 2h sẽ duyệt vào lúc 3h sáng </h4>
                                                </div>
                                            </div>
                                        </div>
										<div class="row">
		...
		<script>
			...
			var stk_atm = "<?php echo CONFIG['GATE']['VIETINBANK']['ACCOUNT_NUMBER'];?>";
