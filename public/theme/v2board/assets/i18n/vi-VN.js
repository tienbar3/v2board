window.settings.i18n['vi-VN'] = {
  ...
  '已过期': 'Tài khoản hết hạn',
  '已用 {used} / 总计 {total}': 'Đã sử dụng {used} / Tổng dung lượng {total}',
  '在线设备 {alive_ip}/{device_limit}' : 'Thiết bị Online: {alive_ip}/{device_limit}',
  '重置订阅信息': 'Reset thông tin gói',
  '没有可用节点，如果您未订阅或已过期请': 'Chưa có node khả dụng, nếu bạn chưa mua gói hoặc đã hết hạn hãy',
  '订阅': 'Gói Dịch Vụ',
  '确定重置当前已用流量？': 'Bạn có chắc chắn muốn đặt lại lưu lượng truy cập hiện đang sử dụng không?',
  ...
  '我的工单': 'Liên Hệ Với Chúng Tôi',
  '工单历史': 'Lịch sử ticket',
  '已用流量将在 {reset_day} 日后重置': ' data được reset sau {reset_day} ngày',
  '已用流量已在今日重置': ' data được reset hôm nay',
  '重置已用流量': 'Đặt lại dung lượng',
  '查看节点状态': 'Trạng thái máy chủ',
  '当前已使用流量达{rate}%': 'Bạn đã sử dụng hết {rate}% data của gói',
  '节点名称': 'Tên node',
  ...
  '快速将节点导入对应客户端进行使用': 'Muốn đồng bộ hóa máy chủ bạn cần có gói dịch vụ',
  '对您当前的订阅进行续费': 'Gia hạn gói hiện tại',
  '对您当前的订阅进行购买': 'Mua gói phù hợp',
  '捷径': 'Phím tắt',
  ...
  '选择最适合你的计划': 'Chọn gói phù hợp với bạn nhất',
  '全部': 'Tất cả',
  '按周期': 'Chu kỳ',
  '遇到问题': 'Trung tâm ticket hỗ trợ',
  '遇到问题可以通过工单与我们沟通': 'cần hỗ trợ hãy tạo ticket ',
  '按流量': 'Theo lưu lượng',
  '搜索文档': 'Tìm kiếm tài liệu',
  '技术支持': 'Hỗ trợ kỹ thuật',
  '当前剩余佣金': 'Hoa hồng còn lại',
  '三级分销比例': 'Tỷ lệ phân phối cấp ba',
  '累计获得佣金': 'Hoa hồng tích lũy',
  '发放时间': 'Thời gian duyệt',
  '查看使用教程': 'Xem hướng dẫn',
  ' 人': ' Người',
  '您邀请的用户再次邀请用户将按照订单金额乘以分销等级的比例进行分成。': 'Người dùng bạn mời, người mời lại bạn sẽ được chia theo tỷ lệ số lượng đơn hàng nhân với mức độ phân phối.。'
};